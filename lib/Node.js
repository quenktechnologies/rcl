...
var Route = (function () {
    function Route(method, pattern, filters, action, location) {
        this.method = method;
...
var Filter = (function () {
    function Filter(target, args, location) {
        this.target = target;
        this.args = args;
        this.location = location;
        this.type = 'filter';
...
var ControllerAction = (function () {
    function ControllerAction(target, member, args, location) {
        this.target = target;
        this.member = member;
        this.args = args;
        this.location = location;
        this.type = 'controller-action';
    }
    return ControllerAction;
}());
exports.ControllerAction = ControllerAction;
var ViewAction = (function () {
    function ViewAction(view, context, location) {
        this.view = view;
        this.context = context;
        this.location = location;
        this.type = 'view-action';
    }
    return ViewAction;
}());

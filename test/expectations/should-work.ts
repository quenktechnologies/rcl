...
_app.delete('/users/:id', (_req, _res) => {
   ...
   let _ctx = new tendril.app.actions.Context (_req, _res, [r=>random(r,args,process.env.value) ], r=>_users.delete (r), _mod);
   _ctx.next(); 
 })
...
_app.get('/', (_req, _res) => {
   ...
   let _ctx = new tendril.app.actions.Context (_req, _res, [],  _r=> tendril.app.actions.render('main/index',{ name : 'Nikosi'  } ) , _mod);
   _ctx.next(); 
 }) 
 } 